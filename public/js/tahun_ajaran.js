$(document).ready(function () {
    $(".dtTahun_ajaran .dataTable-dropdown label").before("<button class='btn btn-primary' id='btnAddTahun_ajaran'>Tambah Data </button>  ");

});

$(document).on("click", "#btnAddTahun_ajaran", function () {
